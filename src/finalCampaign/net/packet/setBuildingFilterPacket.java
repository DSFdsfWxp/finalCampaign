...
public class setBuildingFilterPacket extends fcPacket {
    ...
    public void handleClient() {
        fcAction.setBuildingFilter(this.__caller, this.building, this.data);
    }

    @Override
    public void handleServer(Player player) {
        super.handleServer(player);
        if (fcAction.setBuildingFilter(player, this.building, this.data)) fcNet.send(this);
    }
