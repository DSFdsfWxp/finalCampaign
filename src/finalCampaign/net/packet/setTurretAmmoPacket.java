...
public class setTurretAmmoPacket extends fcPacket {
    ...
    public void handleClient() {
        fcAction.setTurretAmmo(this.__caller, this.unit, this.building, this.item, this.amount);
    }

    @Override
    public void handleServer(Player player) {
        super.handleServer(player);
        if (fcAction.setTurretAmmo(player, this.unit, this.building, this.item, this.amount)) fcNet.send(this);
    }
