...
public class setTurretPreferBuildingTargetPacket extends fcPacket {
    ...
    public void handleClient() {
        fcAction.setTurretPreferBuildingTarget(this.__caller, this.building, this.v);
    }

    @Override
    public void handleServer(Player player) {
        super.handleServer(player);
        if (fcAction.setTurretPreferBuildingTarget(player, this.building, this.v)) fcNet.send(this);
    }
