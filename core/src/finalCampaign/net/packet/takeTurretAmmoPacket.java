...
public class takeTurretAmmoPacket extends fcPacket {
    ...
    public void handleClient() {
        fcAction.takeTurretAmmo(this.__caller, this.unit, this.building, this.item, this.amount);
    }

    @Override
    public void handleServer(Player player) {
        super.handleServer(player);
        if (fcAction.takeTurretAmmo(player, this.unit, this.building, this.item, this.amount)) fcNet.send(this);
    }
