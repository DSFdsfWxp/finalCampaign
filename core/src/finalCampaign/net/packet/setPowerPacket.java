...
public class setPowerPacket extends fcPacket {
    ...
    public void handleClient() {
        fcAction.setPower(this.__caller, this.building, this.amount);
    }

    @Override
    public void handleServer(Player player) {
        super.handleServer(player);
        if (fcAction.setPower(player, this.building, this.amount)) fcNet.send(this);
    }
