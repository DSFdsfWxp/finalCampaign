...
public class setBuildingForceDisablePredictTargetPacket extends fcPacket {
    ...
    public void handleClient() {
        fcAction.setBuildingForceDisablePredictTarget(this.__caller, this.building, this.v);
    }

    @Override
    public void handleServer(Player player) {
        super.handleServer(player);
        if (fcAction.setBuildingForceDisablePredictTarget(player, this.building, this.v)) fcNet.send(this);
    }
