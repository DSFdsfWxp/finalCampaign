...
public class desktopLauncher extends shareLauncher {
    ...
    public static void main(String[] arg) throws Exception {
        ...
        bothFi thisJar = new bothFi(new File(desktopLauncher.class.getProtectionDomain().getCodeSource().getLocation().toURI()));
        bothFi path = thisJar.parent().parent().parent().parent();
